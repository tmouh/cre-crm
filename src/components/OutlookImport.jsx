      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">Import from Outlook</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {step === STEP.CONNECT && (
            <div className="flex flex-col items-center text-center py-8 gap-5">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-1">Connect your Microsoft account</p>
              ...
              {msAccount && (
                <p className="text-xs text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 px-3 py-1.5 rounded-full">
          ...
          {/* FETCHING */}
          {step === STEP.FETCHING && (
            <div className="flex flex-col items-center py-14 gap-3 text-gray-500 dark:text-gray-400">
          ...
          {step === STEP.PREVIEW && (
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button onClick={selectAllVisible} className="text-xs px-2 py-1 rounded-md bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors">
                  Select all{previewSearch ? ' visible' : ''}
                </button>
                <button onClick={deselectAllVisible} className="text-xs px-2 py-1 rounded-md bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors">
              ...
              <label className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl cursor-pointer">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-800 dark:text-gray-200">Import email history (last 90 days)</p>
              ...
              <div className="border border-gray-100 dark:border-gray-700 rounded-xl overflow-hidden">
                {/* Sticky header */}
                <div className="grid grid-cols-[32px_1fr_1fr_1fr_60px] gap-1 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700 px-3 py-2.5 text-xs font-semibold text-gray-500 dark:text-gray-400">
                  <div>
                    <input
                      type="checkbox"
                    ...
                    {virtualizer.getVirtualItems().map(vRow => {
                      ...
                      return (
                        <div
                          key={c.id}
                          className={clsx(
                            'grid grid-cols-[32px_1fr_1fr_1fr_60px] gap-1 px-3 items-center border-b border-gray-50 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer',
                        ...
                        >
                          ...
                          <div className="text-sm font-medium text-gray-800 dark:text-gray-200 truncate" title={name}>
                            {name || '—'}
                            {cats.length > 0 && (
                              <span className="ml-1.5 text-[10px] text-purple-500 dark:text-purple-400 font-normal">{cats.join(', ')}</span>
                            )}
                          </div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 truncate" title={email}>{email || '—'}</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 truncate" title={c.companyName}>{c.companyName || '—'}</div>
                          <div>
                            {exists
                              ? <span className="badge bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400 text-[10px]">Exists</span>
